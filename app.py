...
# --- SIDEBAR ---
with st.sidebar:
    st.markdown("### 🍿 Progressive Downloader")
    st.subheader("About the Developer")
    st.markdown("Hi, I'm Garvit Bhojak. 👋")
    ...
    st.markdown("🔗 **Connect**")
    st.markdown("[GitHub Profile](https://github.com/garvitbhojak)")
    st.markdown("[Instagram: @garvitbhojak](https://www.instagram.com/garvitbhojak)")
...
st.title("Progressive Downloader")
...
with st.expander("ℹ️ How does this work?"):
    st.markdown(
        ...
        "From that Video Player you can download the video and play it on your local machine video player while downloading."
    )
